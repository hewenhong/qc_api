...
from nova.api.qingcloud_openstack.compute.views import addresses as views_addresses
from nova.api.qingcloud_openstack.compute.views import flavors as views_flavors
