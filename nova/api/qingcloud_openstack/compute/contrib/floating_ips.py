...
class FloatingIPActionController(wsgi.Controller):
    ...
    def _add_floating_ip(self, req, id, body):
        ...
        try:
            eip_id = body['addFloatingIp']['address']
        except TypeError:
...
#
        try:
            eip = self.conn.associate_eip(eip=eip_id, instance=id)
...
class Floating_ips(extensions.ExtensionDescriptor):
    ...
    namespace = "http://docs.qingcloud_openstack.org/compute/ext/floating_ips/api/v1.1"
