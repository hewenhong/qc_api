...
from nova.api.qingcloud_openstack import api_version_request as api_version
from nova.api.qingcloud_openstack import versioned_method
...
_SUPPORTED_CONTENT_TYPES = (
    'application/json',
    'application/vnd.qingcloud_openstack.compute+json',
)

_MEDIA_TYPE_MAP = {
    'application/vnd.qingcloud_openstack.compute+json': 'json',
